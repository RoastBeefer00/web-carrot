...
var app = (function () {
    ...
    function create_else_block_1$1(ctx) {
    	...
    	const block_1 = {
    		c: function create() {
    			...
    			add_location(button, file$g, 54, 2, 1124);
    		},
    ...
    function create_if_block$6(ctx) {
    	...
    	const block_1 = {
    		c: function create() {
    			...
    			add_location(a, file$g, 37, 2, 866);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$f = "node_modules/sveltestrap/src/Card.svelte";
    ...
    const file$e = "node_modules/sveltestrap/src/CardBody.svelte";
    ...
    class CardHeader extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$d, create_fragment$d, safe_not_equal, { class: 3, tag: 0 });
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h6, file$c, 9, 0, 168);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$b, 9, 0, 165);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* node_modules/sveltestrap/src/ListGroup.svelte generated by Svelte v3.48.0 */
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$4, 19, 2, 384);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ol, file$4, 15, 2, 315);
    		},
    		m: function mount(target, anchor) {
    ...
    class ListGroup extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { class: 3, flush: 4, numbered: 0 });
    ...
    /* node_modules/sveltestrap/src/ListGroupItem.svelte generated by Svelte v3.48.0 */
    const file$3 = "node_modules/sveltestrap/src/ListGroupItem.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$3, 36, 2, 749);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (default_slot) default_slot.c();
    			set_attributes(button, button_data);
    			add_location(button, file$3, 25, 2, 602);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (default_slot) default_slot.c();
    			set_attributes(a, a_data);
    			add_location(a, file$3, 21, 2, 479);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    ...
    /* public/card.svelte generated by Svelte v3.48.0 */

    const { console: console_1$1 } = globals;
    const file$1 = "public/card.svelte";
    ...
    // (1:0) <script>     async function getRecipes() {   let response = await fetch("http://localhost:8050/api/getrandom");   let recipes = await response.json();   return recipes;  }
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script>     async function getRecipes() {   let response = await fetch(\\\"http://localhost:8050/api/getrandom\\\");   let recipes = await response.json();   return recipes;  }",
    		ctx
    	});
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, recipes, visible*/ 8195) {
    ...
    // (72:16) <CardTitle style="color:#EDF5E1;">
    function create_default_slot_14(ctx) {
    	let t_value = /*recipes*/ ctx[0].title + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*recipes*/ 1 && t_value !== (t_value = /*recipes*/ ctx[0].title + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(72:16) <CardTitle style=\\\"color:#EDF5E1;\\\">",
    		ctx
    	});
    ...
    // (73:16) <CardSubtitle style="color:#EDF5E1">
    function create_default_slot_13(ctx) {
    	let t_value = /*recipes*/ ctx[0].time + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*recipes*/ 1 && t_value !== (t_value = /*recipes*/ ctx[0].time + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(73:16) <CardSubtitle style=\\\"color:#EDF5E1\\\">",
    		ctx
    	});
    ...
    // (74:16) <Button style="background:#379683; color:#EDF5E1" on:click={toggle}>
    function create_default_slot_12(ctx) {
    	...
    	icon = new Icon({
    			props: {
    				name: /*visible*/ ctx[1] ? "chevron-up" : "chevron-down"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const icon_changes = {};
    			if (dirty & /*visible*/ 2) icon_changes.name = /*visible*/ ctx[1] ? "chevron-up" : "chevron-down";
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(74:16) <Button style=\\\"background:#379683; color:#EDF5E1\\\" on:click={toggle}>",
    		ctx
    	});
    ...
    // (75:16) <Button style="float:right; margin-left:20px; background:#379683; color:#EDF5E1" on:click={removeRecipe(recipes)}>
    function create_default_slot_11(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(75:16) <Button style=\\\"float:right; margin-left:20px; background:#379683; color:#EDF5E1\\\" on:click={removeRecipe(recipes)}>",
    		ctx
    	});
    ...
    // (76:16) <Button style="float:right; margin-left:100px; background:#379683; color:#EDF5E1" on:click={replaceRecipe(recipes)}>
    function create_default_slot_10(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(76:16) <Button style=\\\"float:right; margin-left:100px; background:#379683; color:#EDF5E1\\\" on:click={replaceRecipe(recipes)}>",
    		ctx
    	});
    ...
    // (71:12) <CardHeader style="background:#05386B">
    function create_default_slot_9(ctx) {
    	...
    	button0 = new Button({
    			props: {
    				style: "background:#379683; color:#EDF5E1",
    	...
    	button1 = new Button({
    			props: {
    				style: "float:right; margin-left:20px; background:#379683; color:#EDF5E1",
    	...
    	button1.$on("click", function () {
    		if (is_function(/*removeRecipe*/ ctx[2](/*recipes*/ ctx[0]))) /*removeRecipe*/ ctx[2](/*recipes*/ ctx[0]).apply(this, arguments);
    	});

    	button2 = new Button({
    			props: {
    				style: "float:right; margin-left:100px; background:#379683; color:#EDF5E1",
    	...
    	button2.$on("click", function () {
    		if (is_function(/*replaceRecipe*/ ctx[3](/*recipes*/ ctx[0]))) /*replaceRecipe*/ ctx[3](/*recipes*/ ctx[0]).apply(this, arguments);
    	});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(71:12) <CardHeader style=\\\"background:#05386B\\\">",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 78, 12, 2365);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    // (81:20) <CardTitle style="color:#05386B">
    function create_default_slot_8(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(81:20) <CardTitle style=\\\"color:#05386B\\\">",
    		ctx
    	});
    ...
    function create_default_slot_7(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const input_changes = {};
    			if (dirty & /*recipes*/ 1) input_changes.label = /*ingredient*/ ctx[10];
    ...
    // (84:28) {#each recipes.ingredients as ingredient}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(84:28) {#each recipes.ingredients as ingredient}",
    		ctx
    	});
    ...
    function create_default_slot_6(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value_1 = /*recipes*/ ctx[0].ingredients;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*recipes*/ 1) {
    				each_value_1 = /*recipes*/ ctx[0].ingredients;
    				validate_each_argument(each_value_1);
    				let i;
    ...
    // (91:20) <CardTitle style="color:#05386B">
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(91:20) <CardTitle style=\\\"color:#05386B\\\">",
    		ctx
    	});
    ...
    // (94:24) <ListGroupItem style="background:#EDF5E1; color:#05386B">
    function create_default_slot_3$1(ctx) {
    	let t_value = /*step*/ ctx[7] + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*recipes*/ 1 && t_value !== (t_value = /*step*/ ctx[7] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(94:24) <ListGroupItem style=\\\"background:#EDF5E1; color:#05386B\\\">",
    		ctx
    	});
    ...
    // (93:20) {#each recipes.steps as step}
    function create_each_block$1(ctx) {
    	...
    	listgroupitem = new ListGroupItem({
    			props: {
    				style: "background:#EDF5E1; color:#05386B",
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(93:20) {#each recipes.steps as step}",
    		ctx
    	});
    ...
    // (92:20) <ListGroup numbered>
    function create_default_slot_2$1(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value = /*recipes*/ ctx[0].steps;
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*recipes*/ 1) {
    				each_value = /*recipes*/ ctx[0].steps;
    				validate_each_argument(each_value);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(92:20) <ListGroup numbered>",
    		ctx
    	});
    ...
    // (80:16) <CardBody style="background:#8EE4AF">
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(80:16) <CardBody style=\\\"background:#8EE4AF\\\">",
    		ctx
    	});
    ...
    // (68:24)              <p>Loading...</p>         {:then recipes}
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 68, 12, 1567);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(68:24)              <p>Loading...</p>         {:then recipes}",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	handle_promise(promise = /*recipes*/ ctx[0], info);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*recipes*/ 1 && promise !== (promise = /*recipes*/ ctx[0]) && handle_promise(promise, info)) ; else {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 65, 0, 1500);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let $undo;
    	let $storeFE;
    	validate_store(undo, 'undo');
    	component_subscribe($$self, undo, $$value => $$invalidate(5, $undo = $$value));
    	validate_store(storeFE, 'storeFE');
    	component_subscribe($$self, storeFE, $$value => $$invalidate(6, $storeFE = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	function removeRecipe(recipe) {
    		for (let index = 0; index < $storeFE.length; index++) {
    			if ($storeFE[index] == recipe) {
    				var l = $undo.length;
    				set_store_value(undo, $undo[l] = { "task": "Delete", index, recipe }, $undo);
    			}
    		}

    		console.log($undo);
    		set_store_value(storeFE, $storeFE = $storeFE.filter(r => r !== recipe), $storeFE);
    	}
    	...
    	async function replaceRecipe(recipe) {
    		for (let index = 0; index < $storeFE.length; index++) {
    			if ($storeFE[index] == recipe) {
    				var l = $undo.length;
    				set_store_value(undo, $undo[l] = { "task": "Replace", index, recipe }, $undo);
    				set_store_value(storeFE, $storeFE[index] = await getRecipes$1(), $storeFE);
    			}
    		}
    	...
    	return [recipes, visible, removeRecipe, replaceRecipe, toggle];
    }

    class Card_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { recipes: 0 });
    		...
    		if (/*recipes*/ ctx[0] === undefined && !('recipes' in props)) {
    			console_1$1.warn("<Card> was created without expected prop 'recipes'");
    		}
    	}
    ...
    // (79:2) <Button style="display: inline-block; margin-left:20px; background:#05386B; color:#EDF5E1" on:click={getFilteredRecipes(filter)}>
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(79:2) <Button style=\\\"display: inline-block; margin-left:20px; background:#05386B; color:#EDF5E1\\\" on:click={getFilteredRecipes(filter)}>",
    		ctx
    	});
    ...
    // (88:2) <Button style="display: inline-block; margin-left: 20px; background:#05386B; color:#EDF5E1" on:click={addMultipleRecipes(value)}>
    function create_default_slot_2(ctx) {
    	let icon;

    	let t_value = (/*value*/ ctx[0] !== 1 && /*value*/ ctx[0] !== null
    	? " Add " + /*value*/ ctx[0] + " recipes!"
    	: " Add recipe!") + "";
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*value*/ 1) && t_value !== (t_value = (/*value*/ ctx[0] !== 1 && /*value*/ ctx[0] !== null
    			? " Add " + /*value*/ ctx[0] + " recipes!"
    			: " Add recipe!") + "")) set_data_dev(t, t_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(icon.$$.fragment, local);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(88:2) <Button style=\\\"display: inline-block; margin-left: 20px; background:#05386B; color:#EDF5E1\\\" on:click={addMultipleRecipes(value)}>",
    		ctx
    	});
    ...
    // (89:2) <Button style="float:right; background:darkred; margin-right:20px" on:click={removeAllRecipes}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(89:2) <Button style=\\\"float:right; background:darkred; margin-right:20px\\\" on:click={removeAllRecipes}>",
    		ctx
    	});
    ...
    // (90:2) <Button style="float:right; margin-right:20px; background:#EDF5E1; border:#05386B; color:#05386B" on:click={undoTask} disabled={$undo.length == 0}>
    function create_default_slot(ctx) {
    	let icon;

    	let t_value = (/*$undo*/ ctx[2].length == 0
    	? " Undo"
    	: " Undo " + /*$undo*/ ctx[2][/*$undo*/ ctx[2].length - 1].task) + "";

    	let t;
    	let current;

    	icon = new Icon({
    			props: { name: "arrow-counterclockwise" },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*$undo*/ 4) && t_value !== (t_value = (/*$undo*/ ctx[2].length == 0
    			? " Undo"
    			: " Undo " + /*$undo*/ ctx[2][/*$undo*/ ctx[2].length - 1].task) + "")) set_data_dev(t, t_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(icon.$$.fragment, local);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(90:2) <Button style=\\\"float:right; margin-right:20px; background:#EDF5E1; border:#05386B; color:#05386B\\\" on:click={undoTask} disabled={$undo.length == 0}>",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	recipecard = new Card_1({
    			props: { recipes: /*recipe*/ ctx[12] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(recipecard.$$.fragment);
    			t = space();
    			add_location(div, file, 95, 3, 2940);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(recipecard, div, null);
    			append_dev(div, t);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const recipecard_changes = {};
    			if (dirty & /*$storeFE*/ 8) recipecard_changes.recipes = /*recipe*/ ctx[12];
    			recipecard.$set(recipecard_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(recipecard.$$.fragment, local);
    		...
    		o: function outro(local) {
    			transition_out(recipecard.$$.fragment, local);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(95:2) {#each $storeFE as recipe}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	if (/*filter*/ ctx[1] !== void 0) {
    		input0_props.value = /*filter*/ ctx[1];
    	}

    	input0 = new Input({ props: input0_props, $$inline: true });
    	binding_callbacks.push(() => bind(input0, 'value', input0_value_binding));
    	input0.$on("keypress", /*keypress_handler*/ ctx[9]);

    	button0 = new Button({
    			props: {
    				style: "display: inline-block; margin-left:20px; background:#05386B; color:#EDF5E1",
    	...
    	button0.$on("click", function () {
    		if (is_function(/*getFilteredRecipes*/ ctx[4](/*filter*/ ctx[1]))) /*getFilteredRecipes*/ ctx[4](/*filter*/ ctx[1]).apply(this, arguments);
    	});
    	...
    	if (/*value*/ ctx[0] !== void 0) {
    		input1_props.value = /*value*/ ctx[0];
    	}
    	...
    	button1.$on("click", function () {
    		if (is_function(/*addMultipleRecipes*/ ctx[5](/*value*/ ctx[0]))) /*addMultipleRecipes*/ ctx[5](/*value*/ ctx[0]).apply(this, arguments);
    	});

    	button2 = new Button({
    			props: {
    				style: "float:right; background:darkred; margin-right:20px",
    	...
    	button2.$on("click", /*removeAllRecipes*/ ctx[6]);

    	button3 = new Button({
    			props: {
    				style: "float:right; margin-right:20px; background:#EDF5E1; border:#05386B; color:#05386B",
    				disabled: /*$undo*/ ctx[2].length == 0,
    	...
    	button3.$on("click", /*undoTask*/ ctx[7]);
    	let each_value = /*$storeFE*/ ctx[3];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			h1 = element("h1");
    			h1.textContent = "We need to cook.";
    			t1 = space();
    			div0 = element("div");
    			...
    			div3 = element("div");
    			img = element("img");
    			attr_dev(h1, "class", "svelte-1xdqyxp");
    			add_location(h1, file, 69, 1, 1560);
    			set_style(p, "display", "inline-block");
    			set_style(p, "margin-left", "20px");
    			set_style(p, "color", "white");
    			add_location(p, file, 79, 2, 1977);
    			set_style(div0, "white-space", "nowrap");
    			add_location(div0, file, 70, 1, 1587);
    			set_style(div1, "background", "#379683");
    			add_location(div1, file, 68, 1, 1526);
    			add_location(div2, file, 93, 1, 2902);
    			attr_dev(img, "class", "gif svelte-1xdqyxp");
    			if (!src_url_equal(img.src, img_src_value = "homer.gif")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Gotta do the cooking by the book!");
    			add_location(img, file, 101, 2, 3046);
    			add_location(div3, file, 100, 1, 3038);
    			attr_dev(main, "class", "svelte-1xdqyxp");
    			add_location(main, file, 67, 0, 1518);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (!updating_value && dirty & /*filter*/ 2) {
    				updating_value = true;
    				input0_changes.value = /*filter*/ ctx[1];
    				add_flush_callback(() => updating_value = false);
    			}
    			...
    			if (!updating_value_1 && dirty & /*value*/ 1) {
    				...
    				input1_changes.value = /*value*/ ctx[0];
    			...
    			if (dirty & /*$undo*/ 4) button3_changes.disabled = /*$undo*/ ctx[2].length == 0;

    			if (dirty & /*$$scope, $undo*/ 32772) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let $storeFE;
    	validate_store(undo, 'undo');
    	component_subscribe($$self, undo, $$value => $$invalidate(2, $undo = $$value));
    	validate_store(storeFE, 'storeFE');
    	...
    	async function getFilteredRecipes(filter) {
    		...
    		recipes.recipes.forEach(element => {
    			set_store_value(storeFE, $storeFE[l] = element, $storeFE);
    			l++;
    		});
    	}
    	...
    	async function addItem() {
    		...
    		set_store_value(storeFE, $storeFE[l] = await getRecipes(), $storeFE);
    	}
    	...
    	function removeAllRecipes() {
    		set_store_value(storeFE, $storeFE = [], $storeFE);
    	}
    	...
    	async function undoTask() {
    		...
    		if (item.task == "Delete") {
    			for (let index = $storeFE.length - 1; index >= item.index; index--) {
    				set_store_value(storeFE, $storeFE[index + 1] = await $storeFE[index], $storeFE);
    				console.log($storeFE);
    			}

    			set_store_value(storeFE, $storeFE[item.index] = item.recipe, $storeFE);
    		} else {
    			set_store_value(storeFE, $storeFE[item.index] = item.recipe, $storeFE);
    		}

    		set_store_value(undo, $undo = $undo.filter(r => r.recipe !== item.recipe), $undo);
    	}
